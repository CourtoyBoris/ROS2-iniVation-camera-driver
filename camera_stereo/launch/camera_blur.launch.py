...
def generate_launch_description():
	...
	event_topic_name=DeclareLaunchArgument(
		'event_topic_name',
		default_value='eros_event'
	)
	
	kerner_size_blur=DeclareLaunchArgument(
		'kerner_size_blur',
		default_value='3'
	)
	
	topic_name_in_blur=DeclareLaunchArgument(
		'topic_name_in_blur',
		default_value='EROS_OUT'
	)
	
	topic_name_in_image_visu=DeclareLaunchArgument(
		'topic_name_in_image_visu',
		default_value='BLUR_OUT'
	...
	parameter_eros = {'number_of_topics':LaunchConfiguration('number_of_topics'),
				'event_topic_name':LaunchConfiguration('event_topic_name')}
	
	parameter_blur = {'kerner_size_blur':LaunchConfiguration('kerner_size_blur'),
			   'topic_name_in_blur':LaunchConfiguration('topic_name_in_blur')}
	...
	nodes.append(kerner_size_blur)
	nodes.append(topic_name_in_blur)
	...
	nodes.append(Node(package='camera',executable='eros',parameters=[parameter_eros],output='screen'))
	nodes.append(Node(package='camera',executable='blur_filter',parameters=[parameter_blur],output='screen'))

...
def generate_launch_description():
	...
	parameter_visualizer = {'number_of_topics':LaunchConfiguration('number_of_topics'),
				'event_topic_name':LaunchConfiguration('event_topic_name'),
				'temp_decrease':LaunchConfiguration('temp_decrease'),
			   	'temp_value':LaunchConfiguration('temp_value')}
